...
| `PLOREA_CLIENT_KEY` | `plorea.client_key` | — | Adyen client key from Plorea, for mounting Drop-in yourself. Used when a session response carries none — see [Checkout](checkout.md) |
